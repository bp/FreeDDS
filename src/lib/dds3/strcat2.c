static char rcsid[]="$Id: strcat2.c 16 2009-01-06 21:52:47Z user $";
/*
RCS-t=DDS, concatenate two strings onto DDS_STRING.
...
DDS_STRING * ddsStrCat2(
   ...
   const char *from2)
{
   size_t old_len, cat_len, cat_len2;
   size_t cat_size, new_size;
   char *ptr;

   cat_len  = strlen(from);
   cat_len2 = strlen(from2);
   cat_size = cat_len + cat_len2;
