static char rcsid[]="$Id: fx_mod.c 39 2009-01-13 23:00:15Z user $";
/*
...
HOST_FTN_INT
HOST_FTN_FUNC(fddx_mod, FDDX_MOD)(
   ...
   )
{
   ...
   return cddx_mod(alias_str.ptr, value_str.ptr, title_str.ptr, *old_tag);
}
