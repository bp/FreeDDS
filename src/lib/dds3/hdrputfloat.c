static char rcsid[]="$Id: hdrputfloat.c 16 2009-01-06 21:52:47Z user $";
/*
RCS-t=DDS, put header float value into binary buffer
   ...
   DDS_BLOCK *block)
{
   ...
   CON_NAVV(type->ptype, DDS_CTYPE_FLOAT, buf, bin_hdr, type->count);
