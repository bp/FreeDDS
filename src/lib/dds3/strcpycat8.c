static char rcsid[]="$Id: strcpycat8.c 16 2009-01-06 21:52:47Z user $";
/*
RCS-t=DDS, copy string and concatenate seven more strings onto DDS_STRING.
   ...
   const char *from8)
{
   ...
   size_t cat_len6, cat_len7, cat_len8;
   char *ptr;
   ...
   memcpy(ptr, from8, cat_len8); ptr += cat_len8;
   *ptr = '\0';
