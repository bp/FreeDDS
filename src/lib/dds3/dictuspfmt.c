static char rcsid[]="$Id: dictuspfmt.c 16 2009-01-06 21:52:47Z user $";
/*
RCS-t=DDS, open and initialize "usp.fmt:" dictionary.
   ...
   DDS_MEDIA_STATE media_state)
{
   ...
   dict = ddsDictNew("usp.fmt:", dict_state, media_state,
