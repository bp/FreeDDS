static char rcsid[]="$Id: f_mod.c 39 2009-01-13 23:00:15Z user $";
/*
...
HOST_FTN_INT
HOST_FTN_FUNC(fdds_mod, FDDS_MOD)(
   ...
   HOST_FTN_LEN history_len)
{
   ...
   dict = cdds_mod(alias_str.ptr, value_str.ptr, title_str.ptr, history_str.ptr);
