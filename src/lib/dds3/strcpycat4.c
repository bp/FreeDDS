static char rcsid[]="$Id: strcpycat4.c 16 2009-01-06 21:52:47Z user $";
/*
RCS-t=DDS, copy string and concatenate three more strings onto DDS_STRING.
   ...
   const char *from4)
{
   ...
   size_t cat_len2, cat_len3, cat_len4;
   char *ptr;
   ...
   str_size = cpy_len + cat_len2 + cat_len3 + cat_len4;
