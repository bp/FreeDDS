static char rcsid[]="$Id: dictaspmap.c 16 2009-01-06 21:52:47Z user $";
/*
RCS-t=DDS, open and initialize "asp.map:" dictionary.
   ...
   DDS_MEDIA_STATE media_state)
{
   ...
   dict = ddsDictNew("asp.map:", dict_state, media_state,
