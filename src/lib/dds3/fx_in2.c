static char rcsid[]="$Id: fx_in2.c 39 2009-01-13 23:00:15Z user $";
/*
RCS-t=DDS API, convenience routine for binary input data with headers & Samples
*/
...
HOST_FTN_INT
HOST_FTN_FUNC(fddx_in2, FDDX_IN2)(
   ...
   )
{
   ...
   return cddx_in2(alias_str.ptr, value_str.ptr, title_str.ptr);
}
