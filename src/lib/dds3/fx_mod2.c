static char rcsid[]="$Id: fx_mod2.c 39 2009-01-13 23:00:15Z user $";
/*
...
HOST_FTN_INT
HOST_FTN_FUNC(fddx_mod2, FDDX_MOD2)(
   ...
   )
{
   ...
   return cddx_mod2(alias_str.ptr, value_str.ptr, title_str.ptr, *old_tag);
}
