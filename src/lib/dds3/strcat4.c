static char rcsid[]="$Id: strcat4.c 16 2009-01-06 21:52:47Z user $";
/*
RCS-t=DDS, concatenate four strings onto DDS_STRING.
...
DDS_STRING * ddsStrCat4(
   ...
   const char *from4)
{
   size_t old_len, cat_len, cat_len2, cat_len3, cat_len4;
   ...
   cat_size = cat_len + cat_len2 + cat_len3 + cat_len4;
