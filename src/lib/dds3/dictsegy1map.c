static char rcsid[]="$Id: dictsegy1map.c 16 2009-01-06 21:52:47Z user $";
/*
RCS-t=DDS, open and initialize "segy1.map:" dictionary.
   ...
   DDS_MEDIA_STATE media_state)
{
   ...
   dict = ddsDictNew("segy1.map:", dict_state, media_state,
