static char rcsid[]="$Id: trybig3smart.c 13 2009-01-06 16:56:43Z user $";
/*
   ...
   const char** argv)
{
   ...
   setup.title = "13: smart verify and speed, big 3 fixed combinations";
   /* similar to previous test, limited combinations,
