static char rcsid[]="$Id: tryspeedbig3.c 13 2009-01-06 16:56:43Z user $";
/*
   ...
   const char** argv)
{
   ...
   setup.title = "11: speed comparison, big 3 fixed combinations";
   /* similar to previous test, testing speed (not verify).
   */
   setup.pass_max = 1;
   setup.size_max = 2;
